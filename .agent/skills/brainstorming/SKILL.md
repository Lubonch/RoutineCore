...
5. **Persist design only if requested** — save to `docs/plans/YYYY-MM-DD-<topic>-design.md` only when the user explicitly asks for a design artifact; otherwise keep the approved design in chat or ephemeral scratch outside the repo
6. **Transition to planning or implementation** — invoke writing-plans only when the user asks for a written implementation plan or a plan-driven workflow
...
**Documentation:**
- If the user explicitly asks for a saved design artifact, write the validated design to `docs/plans/YYYY-MM-DD-<topic>-design.md`
- Otherwise keep the validated design in chat or, if necessary, in ephemeral scratch outside the repo and delete that scratch before completion
