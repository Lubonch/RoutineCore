...
**Personal skills may live in a user-level directory when your environment supports one, but project-local skills should remain the primary source of truth.**
...
**Purpose:** The agent reads description metadata to decide which skills to load for a given task. Make it answer: "Should I read this skill right now?"
...
**IMPORTANT:** Track this checklist in chat or, if temporary scratch is truly needed, in ephemeral scratch outside the repository. Do not require a persistent tracker file in the repo unless the user explicitly asked for one.
